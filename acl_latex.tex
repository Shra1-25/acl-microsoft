...
On SWE-Bench Verified and the Java and Python splits of SWE-PolyBench, our scaffolding pairs a Qwen2.5-Coder-3B scorer with a 30B Step-C agent to match or exceed an un-fine-tuned 30B baseline at roughly an order of magnitude lower token consumption per issue.
