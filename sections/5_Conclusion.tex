...
Qwen2.5-Coder-3B scorer matches or beats Qwen3-Coder-30B-A3B
under the same scaffolding on Verified, and pairs with a 30B
Step-C agent to set the best Python numbers on SWE-PolyBench.
