...
\citep{jimenez2024swebench, yang2024sweagent}. The strongest
systems are built around this fact. \citet{xia2024agentless}
...
that can sit far from the code that must change. Current systems
close this gap in four ways. Reinforcement learning methods
...
exceed 131K tokens (Section~\ref{sec:efficiency}). A model with a
