...
\citep{yang2025qwen3}, and GPT-5.3 Codex. The first-stage
retriever is either SWERankEmbed-Large
...
\cdashline{1-5}
\emph{w/graph, w/ scorer}  & \textbf{Ours, fine-tuned Qwen2.5-Coder-3B} & $\mathbf{0.55}$ & --    & $\mathbf{35}$  \\
\bottomrule
\end{tabular}
\end{table*}
...
and Accuracy@5 (perfect recall) on the SWE-PolyBench Java and
Python splits, comparing the scaffolding without graph
...
gains $+5$ recall and $+4$ accuracy points and surpasses the
...
have not executed. Tokens/call is averaged across the kept
instances; \#Calls is per issue.}
...
\begin{tabular}{lcccc}
\toprule
Model                          & Rec@5 & Acc@5 & Tok/call & \#Calls \\
\midrule
\multicolumn{5}{l}{\emph{w/o graph (Step B disabled)}} \\
GPT-5.3 Codex                  & $0.38$ & $0.22$ & $5597$ & $3.87$ \\
Qwen3-Coder-30B-A3B            & $0.35$ & $0.20$ & $5847$ & $4.75$ \\
\midrule
\multicolumn{5}{l}{\emph{Full, ours (Qwen2.5-Coder-3B scorer)}} \\
GPT-5.3 Codex                  & $\mathbf{0.43}$ & $\mathbf{0.27}$ & $5504$ & $3.47$ \\
Qwen3-Coder-30B-A3B            & $0.37$ & $0.20$ & $5871$ & $4.56$ \\
\bottomrule
\end{tabular}
\end{subtable}
\hfill
...
\multicolumn{5}{l}{\emph{w/o graph (Step B disabled)}} \\
GPT-5.3 Codex                  & --     & --     & --     & --     \\
Qwen3-Coder-30B-A3B            & $0.40$ & $0.29$ & $8099$ & $4.70$ \\
\midrule
\multicolumn{5}{l}{\emph{Full, ours (Qwen2.5-Coder-3B scorer)}} \\
GPT-5.3 Codex                  & $0.42$ & $0.31$ & $9242$ & $3.34$ \\
Qwen3-Coder-30B-A3B            & $\mathbf{0.45}$ & $\mathbf{0.33}$ & $9778$ & $4.75$ \\
\bottomrule
\end{tabular}
\end{subtable}
\end{table*}
